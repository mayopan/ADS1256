...
// If only one SPI device is connected to esp32, CS pin on ADS1256 may be connected to GND instead of esp32.
const uint8_t pinCS = 5;
const uint8_t pinDataReady = 14;
const uint8_t pinReset = 25;
const uint32_t SPIspeed = 2000000;// This library doesn't use direct read / write register but uses digitalwrite / degitalread. It limits speed around 2MHz.
// Initialize ADS1256 object for esp32
ADS1256 adc(SPIspeed,vRef,pinCS,pinDataReady,pinReset); // RESETPIN is permanently tied to 3.3v
